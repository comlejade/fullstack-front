              ...
              <form method="post">
                ...
                <div class="layui-form-item">
                  ...
                  <ValidationProvider rules="required|min:4" name="name" v-slot="{ errors }">
                    <div class="layui-input-inline">
                      <input type="text" id="L_nickname" v-model="nickname" placeholder="请输入昵称" autocomplete="off"
                        class="layui-input">
                    </div>
                    <div class="layui-form-mid error">{{ errors[0] }}</div>
                  </ValidationProvider>
                ...
                <div class="layui-form-item">
                  ...
                  <ValidationProvider rules="required|min:6|max:16" name="password" vid="confirmation"
                    v-slot="{ errors }">
                    <div class="layui-input-inline">
                ...
                <div class="layui-form-item">
                  ...
                  <ValidationProvider rules="required|min:6|max:16|confirmed:confirmation" name="password"
                    v-slot="{ errors }">
                    <div class="layui-input-inline">
                      <input type="password" id="L_repass" v-model="password_confirm" placeholder="请再次输入密码"
                ...
                <div class="layui-form-item">
                  ...
                  <ValidationProvider rules="required|length:4" name="code" v-slot="{ errors }">
                    <div class="layui-input-inline">
                      <input type="text" id="L_vercode" v-model="vercode" placeholder="请输入验证码" autocomplete="off"
                        class="layui-input">
                    </div>
